#!/usr/bin/env python
"""
Script to train an HRNet model for building segmentation with optional contour awareness.
"""
...
from training.hrnet_trainer import HRNetTrainer
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Train HRNet model for building segmentation")
    ...
    parser.add_argument("--model_save_dir", type=str, default="./checkpoints/hrnet",
...
def main():
    """Main function to train HRNet model."""
    args = parse_args()
