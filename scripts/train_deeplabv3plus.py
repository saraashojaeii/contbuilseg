#!/usr/bin/env python
"""
Script to train a DeepLabV3+ model for building segmentation with optional contour awareness.
"""
...
from training.deeplabv3plus_trainer import DeepLabV3PlusTrainer
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Train DeepLabV3+ model for building segmentation")
    ...
    parser.add_argument("--model_save_dir", type=str, default="./checkpoints/deeplabv3plus",
...
def main():
    """Main function to train DeepLabV3+ model."""
    args = parse_args()
