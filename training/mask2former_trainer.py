"""
Mask2Former trainer for building segmentation tasks.
"""
...
class Mask2FormerTrainer(BaseTrainer):
    """
    Trainer class for Mask2Former model with building segmentation tasks.
    ...
    def __init__(self, model, train_loader, val_loader, device='cuda', 
        ...
        Args:
            model: The Mask2Former model to train
    ...
    def _get_optimizer(self):
        """
        Get AdamW optimizer for Mask2Former.
    ...
    def _get_loss_fn(self):
        """
        Get combined loss function for Mask2Former.
    ...
    def _validate_epoch(self, epoch):
        """Validate Mask2Former for one epoch."""
        self.model.eval()
        running_loss = 0.0
