"""
HRNet trainer for building segmentation tasks.
"""
...
class HRNetTrainer(BaseTrainer):
    """
    Trainer class for HRNet model with building segmentation tasks.
    ...
    def __init__(self, model, train_loader, val_loader, device='cuda', 
        ...
        """
        Initialize the HRNetTrainer.
        
        Args:
            model: The HRNet model to train
    ...
    def _get_loss_fn(self):
        """
        Get combined loss function for HRNet.
